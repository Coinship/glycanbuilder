...
import static org.eurocarbdb.application.glycanbuilder.Geometry.getTextShape;
import static org.eurocarbdb.application.glycanbuilder.Geometry.isDown;
import static org.eurocarbdb.application.glycanbuilder.Geometry.isLeft;
import static org.eurocarbdb.application.glycanbuilder.Geometry.isUp;
...
public abstract class AbstractResidueRenderer implements ResidueRenderer{
    ...
    protected Shape createShape(Residue node, Rectangle par_bbox, Rectangle cur_bbox, Rectangle sup_bbox, ResAngle orientation) {
    	ResidueStyle style = theResidueStyleDictionary.getStyle(node);
    	String shape = style.getShape();
    ...
    protected Shape createTextShape(Residue node, Rectangle par_bbox, Rectangle cur_bbox, Rectangle sup_bbox, ResAngle orientation) {
    	ResidueStyle style = theResidueStyleDictionary.getStyle(node);
    	String shape = style.getShape();
    ...
    protected Shape createFillShape(Residue node, Rectangle cur_bbox) {    
    	ResidueStyle style = theResidueStyleDictionary.getStyle(node);
